    ...
    <div className="grid md:grid-cols-3 gap-5 pb-10">
      <div className="flex items-center bg-white rounded-md overflow-hidden shadow-sm">
        ...
        <div className="px-4 text-gray-700">
          <h3 className="text-base tracking-wider">Total Revenue: </h3>
      ...
      <div className="flex items-center bg-white rounded-md overflow-hidden shadow-sm">
        ...
        <div className="px-4 text-gray-700">
          <h3 className="text-base tracking-wider">Total Reservation: </h3>
      ...
      <div className="flex items-center bg-white rounded-md overflow-hidden shadow-sm">
        ...
        <div className="px-4 text-gray-700">
          <h3 className="text-base tracking-wider">Total Customer: </h3>
